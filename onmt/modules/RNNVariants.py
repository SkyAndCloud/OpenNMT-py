"""
borrowed from https://github.com/seba-1511/lstms.pth/blob/master/lstms/normalize.py
"""
...
class LSTMCell(nn.Module):
    ...
    def sample_mask(self):
        ...
        self.mask = Variable(torch.bernoulli(torch.Tensor(1, self.hidden_size).fill_(keep)))
...
class LayerNormLSTMCell(LSTMCell):
    ...
    def __init__(self, input_size, hidden_size, bias=True, dropout=0.0,
        ...
        super(LayerNormLSTMCell, self).__init__(input_size=input_size,
